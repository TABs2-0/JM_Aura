    ...
    <footer className="bg-[#e4e2dd] dark:bg-[#121210] w-full pt-20 pb-10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 max-w-screen-2xl mx-auto">
        <div className="col-span-1 md:col-span-1">
          <Link to="/" className="text-3xl font-headline italic text-[#1b1c19] dark:text-[#fbf9f4] mb-8 block">JM_Aura</Link>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link className="text-[#1b1c19]/60 dark:text-[#fbf9f4]/60 font-body text-sm hover:text-[#79542e] transition-all" to="/trends">Trends</Link></li>
            <li><Link className="text-[#1b1c19]/60 dark:text-[#fbf9f4]/60 font-body text-sm hover:text-[#79542e] transition-all" to="/about">Our Story</Link></li>
            <li><Link className="text-[#1b1c19]/60 dark:text-[#fbf9f4]/60 font-body text-sm hover:text-[#79542e] transition-all" to="/collections">Collections</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="font-label tracking-widest uppercase text-xs mb-8 text-[#79542e]">Service</h4>
          <ul className="space-y-4">
            <li><Link className="text-[#1b1c19]/60 dark:text-[#fbf9f4]/60 font-body text-sm hover:text-[#79542e] transition-all" to="/contact">Contact</Link></li>
            <li><Link className="text-[#1b1c19]/60 dark:text-[#fbf9f4]/60 font-body text-sm hover:text-[#79542e] transition-all" to="/collections">Shop</Link></li>
            <li><Link className="text-[#1b1c19]/60 dark:text-[#fbf9f4]/60 font-body text-sm hover:text-[#79542e] transition-all" to="/profile">My Account</Link></li>
          </ul>
        </div>
        <div>
