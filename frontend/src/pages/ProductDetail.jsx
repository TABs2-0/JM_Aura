    ...
    <main className="pt-32 pb-20">
      ...
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12 mb-8">
        <nav className="flex space-x-2 text-xs font-label uppercase tracking-widest text-on-surface-variant/60">
          ...
          <span>/</span>
          <Link className="hover:text-primary transition-colors" to={`/collections?product_category=${encodeURIComponent(product.product_category)}`}>{product.product_category}</Link>
          <span>/</span>
